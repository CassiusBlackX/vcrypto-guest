...
#define ASYM_SESSION_POOL_NUM_ELEMS 512
#define ASYM_CRYPTO_OP_POOL_SIZE 8192
#define ASYM_CRYPTO_MBUF_NUM 2048
#define ASYM_CRYPTO_MBUF_SIZE 32768
...
extern struct rte_mempool *asym_crypto_session_pool;
